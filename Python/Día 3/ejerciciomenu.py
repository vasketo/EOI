...
# Realizar un ejemplo de menú, donde podemos escoger las distintas opciones hasta que seleccionamos la opción de
# “Salir”.
...
while True:
    ...
    input ("Pulsa para volver al menú principal.")
    os.system('cls')